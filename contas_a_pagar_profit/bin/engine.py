...
with open(entrada, 'rt') as csvfile:
    ...
    for row in csvreader:
        if str(row[0]) == 'Documento':
            saida.write('Documento/Cheque;Nome Fornecedor;CNPJ Fornecedor;Emissao;Vencimento;Banco Planilha;Banco Oco. Extrato;Data Pagto;Data Oco. Extrato;Valor Pago;Valor Desconto;Valor Juros;Valor Multa;Numero Titulo;Empresa;Codigo Conta Dominio;OBS;Tipo Pagto;Categoria\n')
        else:
            ...
            _nume_nota = str(row[0])
            if _nume_nota.isnumeric():
