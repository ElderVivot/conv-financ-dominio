...
with open(entrada, 'rt') as csvfile:
        ...
        for row in csvreader:
            if str(row[0]) == 'Documento':
                ...
                # o fornedor SIKA é muito comum, e como o nome não bate com o que está na domínio colocamos pra fixo o CNPJ
                if ( _cnpj_for == "'" or _cnpj_for == "'00000000000000") and _nome_for_ori.count('SIKA') > 0:
                    _cnpj_for = "'33081704002210"
