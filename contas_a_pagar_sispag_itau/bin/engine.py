...
with open(entrada, 'rt') as csvfile:
        ...
        for row in csvreader:
            if str(row[0]) == 'Documento':
                ...
                _nome_for_50porcento = _nome_for_ori[0 : int(len(_nome_for_ori)*0.5)]
                ...
                if len(_nome_for_ori) < 10:
                    ...
                    consulta_cnpj_50porcento = cnpj_for(_codi_emp_v, _nome_for_50porcento)
                    ...
                    _cnpj_for_nome_50porcento = apenas_valor_campo_dominio(str(consulta_cnpj_50porcento[0]))
                    _codi_emp_50porcento = apenas_valor_campo_dominio(str(consulta_cnpj_50porcento[1]))
                ...
                elif _cnpj_for_nome_75porcento_ou_menor_que_10_letras != "'":
                    _cnpj_for = _cnpj_for_nome_75porcento_ou_menor_que_10_letras
                    codi_emp = _codi_emp_75porcento_ou_menor_que_10_letras
                else:
                    _cnpj_for = _cnpj_for_nome_50porcento
                    codi_emp = _codi_emp_50porcento
